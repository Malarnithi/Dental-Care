      ...
      <div className='service'>
        ...
        <div className='service-content'>
          ...
          <div className="service2"> 
            ...
            <div className='Service-image'>
              <img src={image2} height='200px' alt="Dental Implant Procedure Image" />
            </div>
          </div>
          <div className="service3">
            ...
            <div className='Service-image'>
              <img src={image3} height='200px' alt="Teeth Filling Process Image" />
            </div>
          </div>
          <div className="service4">
            ...
            <div className='Service-image'>
              <img src={image4} height='200px' alt="Oral Surgery Procedure Image" />
            </div> 
          </div>
          <div className="service5"> 
            ...
            <div className='Service-image'>
              <img src={image5} height='200px' alt="Crown and Bridges Procedure Image" />
            </div>
          </div>
          <div className="service6">
            ...
            <div className='Service-image'>
              <img src={image6} height='200px' alt="Periodontal Care Procedure Image" />
            </div> 
          </div>
        </div>
      </div>
