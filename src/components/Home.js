      ...
      <div className='main-section'>
        <div className='home'>
          <div className='home-content'>
            ...
            <button className='book-btn mt-5'>
              Booking Now <img src={arrow} width='18px' height='18px' alt="arrow icon" />
            </button>
            <div className='home-division'>
              <div className="division1"> 
                <img className='division-image' src={customer} width='100px' height='100px' alt="customer service icon" />
              ...
              <div className="division2">     
                <img className='division-image' src={vector} width='100px' height='100px' alt="expert dentist icon" />
              ...
              <div className="division3">
                <img className='division-image' src={star} width='100px' height='100px' alt="high user rating icon" />
              ...
              <div className="division4"> 
                <img className='division-image' src={chair} width='100px' height='100px' alt="best equipment icon" />
            ...
            <img className='subtract' src={subtract} alt="decorative background" />
            <img className='dental' src={image1} width='40%' height='600px' alt="dental care illustration" />
          </div>
        </div>
      </div>
    </>
